...
ClapTrap::ClapTrap(std::string name) : _name(name), _hitsPoints(100), _energyPoints(50), _attackdamage(20) {
    std::cout << "ClapTrap " << this->_name << " parameterized constructor has been called" << std::endl;
}
